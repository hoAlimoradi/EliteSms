...
import com.alimoradi.smsmms.com.android.mms.MmsConfig;
import com.alimoradi.smsmms.com.google.android.mms.MmsException;
import com.alimoradi.smsmms.com.google.android.mms.pdu_alt.GenericPdu;
import com.alimoradi.smsmms.com.google.android.mms.pdu_alt.NotificationInd;
import com.alimoradi.smsmms.com.google.android.mms.pdu_alt.NotifyRespInd;
import com.alimoradi.smsmms.com.google.android.mms.pdu_alt.PduComposer;
import com.alimoradi.smsmms.com.google.android.mms.pdu_alt.PduHeaders;
import com.alimoradi.smsmms.com.google.android.mms.pdu_alt.PduParser;
import com.alimoradi.smsmms.com.google.android.mms.pdu_alt.PduPersister;
import com.alimoradi.smsmms.com.google.android.mms.pdu_alt.RetrieveConf;
import com.alimoradi.smsmms.com.klinker.android.send_message.BroadcastUtils;

import java.io.IOException;

import timber.log.Timber;
import com.alimoradi.smsmms.com.android.mms.util.DownloadManager;
import static com.alimoradi.smsmms.com.android.mms.transaction.TransactionState.FAILED;
import static com.alimoradi.smsmms.com.android.mms.transaction.TransactionState.INITIALIZED;
import static com.alimoradi.smsmms.com.android.mms.transaction.TransactionState.SUCCESS;
import static com.alimoradi.smsmms.com.android.mms.util.DownloadManager.STATE_DOWNLOADING;
import static com.alimoradi.smsmms.com.android.mms.util.DownloadManager.STATE_UNSTARTED;
import static com.alimoradi.smsmms.com.google.android.mms.pdu_alt.PduHeaders.MESSAGE_TYPE_RETRIEVE_CONF;
import static com.alimoradi.smsmms.com.google.android.mms.pdu_alt.PduHeaders.STATUS_DEFERRED;
import static com.alimoradi.smsmms.com.google.android.mms.pdu_alt.PduHeaders.STATUS_RETRIEVED;
import static com.alimoradi.smsmms.com.google.android.mms.pdu_alt.PduHeaders.STATUS_UNRECOGNIZED;
import static com.alimoradi.smsmms.com.klinker.android.send_message.Transaction.NOTIFY_OF_MMS;
...
public class NotificationTransaction extends Transaction implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            if (!autoDownload) {
                downloadManager.markState(mUri, STATE_UNSTARTED);
                sendNotifyRespInd(status);
                return;
            }

            downloadManager.markState(mUri, STATE_DOWNLOADING);
