...
import com.alimoradi.smsmms.com.android.mms.dom.smil.parser.SmilXmlSerializer
import com.alimoradi.smsmms.com.android.mms.dom.smil.parser.SmilXmlSerializer.*
...
import com.alimoradi.smsmms.com.google.android.mms.ContentType.*
import com.alimoradi.smsmms.com.google.android.mms.InvalidHeaderValueException
import com.alimoradi.smsmms.com.google.android.mms.MMSPart
import com.alimoradi.smsmms.com.google.android.mms.pdu_alt.*
import com.alimoradi.smsmms.com.google.android.mms.smil.SmilHelper
...
class Transaction @JvmOverloads constructor(private val context: Context, settings: Settings = Settings()) {
    ...
    private fun buildPdu(context: Context, recipients: List<String>, subject: String?, parts: List<MMSPart>): SendReq {
        ...
        req.body.addPart(0, PduPart().apply {
            ...
            contentType = APP_SMIL.toByteArray()
            data = ByteArrayOutputStream()
                    .apply { serialize(SmilHelper.createSmilDocument(req.body), this) }
                    .toByteArray()
        })
