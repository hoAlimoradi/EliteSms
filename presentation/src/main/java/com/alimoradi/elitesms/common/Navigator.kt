...
class Navigator @Inject constructor(
    ...
    fun showRating() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.alimoradi.elitesms"))
        ...
        try {
            ...
            val url = "http://play.google.com/store/apps/details?id=com.alimoradi.elitesms"
